    ...
    <div class="register">
      ...
      <form action="login" method="post" class="form">
        ...
        <div class="form__field">
          <input type="text" placeholder="Student Id" id="sid" name="sid">
        </div>
        ...
        <div class="form__field">
          <input type="submit" value="Log In" onclick="return validLogin()">
        </div>

      </form>

      <p>Don't have an account? <a href="registrationForm">Sign Up</a></p>
